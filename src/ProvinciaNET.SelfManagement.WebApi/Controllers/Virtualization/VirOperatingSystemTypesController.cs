...
namespace ProvinciaNET.SelfManagement.WebApi.Controllers.Virtualization
{
    ...
    public class VirOperatingSystemTypesController : ControllerBase
    {
        ...
        private readonly IVirOperatingSystemTypesService _service;
        ...
        public VirOperatingSystemTypesController(ILogger<VirOperatingSystemTypesController> logger, IVirOperatingSystemTypesService service)
        {
            _logger = logger;
            _service = service;
        }
