...
namespace ProvinciaNET.SelfManagement.WebApi.Controllers.Virtualization
{
    ...
    public class VirCategoryTagsController : ControllerBase
    {
        ...
        /// <summary>
        /// Gets all 'VirCategoryTag' resources.
        /// </summary>
        /// <returns></returns>
        [HttpGet, EnableQuery(PageSize = 1000)]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(VirCategoryTag))]
        public async Task<ActionResult<IEnumerable<VirCategoryTag>>> GetVirCategoryTags()
        {
        ...
        /// <summary>
        /// Gets a 'VirCategoryTag' resource by ID.
        /// </summary>
        ...
        public async Task<ActionResult<VirCategoryTag?>> GetVirCategoryTag(int id)
        {
            var entity = await _service.Get(id);
            if (entity == null)
            {
                _logger.LogWarning("Entity 'VirCategoryTag' with Id {id} not found.", id);
                return NotFound();
            }
        ...
        /// <summary>
        /// Creates a 'VirCategoryTag' resource.
        /// </summary>
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        [HttpPost, ODataIgnored]
        [Consumes(MediaTypeNames.Application.Json)]
        [ProducesResponseType(typeof(VirCategoryTag), StatusCodes.Status201Created)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<VirCategoryTag>> PostVirCategoryTag(VirCategoryTag entity)
        {
            if (_service.Get(entity.Id).Result != null)
            {
                _logger.LogWarning("Entity 'VirCategoryTag' with Id {id} already exists.", entity.Id);
                return BadRequest();
            }
            ...
            return CreatedAtAction("GetVirCategoryTag", new { id = entity.Id }, entity);
        }

        /// <summary>
        /// Updates a 'VirCategoryTag' resource by ID.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        ...
        public async Task<IActionResult> PutVirCategoryTag(int id, VirCategoryTag entity)
        {
            if (id != entity.Id)
            {
        ...
        /// <summary>
        /// Deletes a 'VirCategoryTag' resource by ID.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        public async Task<IActionResult> DeleteVirCategoryTag(int id)
        {
            var entity = await _service.Get(id);
            if (entity == null)
            {
