...
namespace ProvinciaNET.SelfManagement.WebApi.Services.Virtualization
{
    ...
    /// </summary>
    /// <seealso cref="IVirOperatingSystemTypesService" />
    public class VirOperatingSystemTypesService : IVirOperatingSystemTypesService
    {
        private readonly SelfManagementContext _context;
        private readonly ILogger<VirOperatingSystemTypesService> _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="VirOperatingSystemTypesService"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets all VirOperatingSystemTypes.
        /// </summary>
        /// <returns></returns>
        public async Task<IEnumerable<VirOperatingSystemType>> Get()
        {
            var result = await _context.VirOperatingSystemTypes.AsNoTracking().ToListAsync();
            _logger.LogInformation("Query Count: {count}", result.Count);
            return result;
        }

        /// <summary>
        /// Gets a VirOperatingSystemType specified by the identifier.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
        public async Task<VirOperatingSystemType?> Get(int id)
        {
            return await _context.VirOperatingSystemTypes.FirstOrDefaultAsync(o => o.Id == id);
        }
        ...
        /// <returns></returns>
        public async Task<VirOperatingSystemType> Post(VirOperatingSystemType entity)
        {
            ...
            try
            {
                ...
                _context.VirOperatingSystemTypes.Add(entity);
        ...
        /// <param name="id">The identifier.</param>
        /// <param name="entity">The entity.</param>
        public async Task Put(int id, VirOperatingSystemType entity)
        {
            var existing = await _context.VirOperatingSystemTypes.FirstAsync(o => o.Id == id);
        ...
        {
            var entity = await _context.VirOperatingSystemTypes.FirstAsync(o => o.Id == id);

            try
            {
                _logger.LogInformation("Deleting resource.");

                _context.VirOperatingSystemTypes.Remove(entity);
                await _context.SaveChangesAsync();
