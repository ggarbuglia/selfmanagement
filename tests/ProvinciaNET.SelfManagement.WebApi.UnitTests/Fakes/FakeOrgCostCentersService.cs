...
namespace ProvinciaNET.SelfManagement.WebApi.UnitTests.Fakes
{
    internal class FakeOrgCostCentersService : IOrgCostCentersService
    {
        ...
        public FakeOrgCostCentersService()
        {
            ...
            _items.Add(new OrgCostCenter() { Id = 1, Name = "Cost Center 1", Active = true, CreatedBy = "System", CreatedOn = DateTime.Now } );
            _items.Add(new OrgCostCenter() { Id = 2, Name = "Cost Center 2", Active = true, CreatedBy = "System", CreatedOn = DateTime.Now });
        }
