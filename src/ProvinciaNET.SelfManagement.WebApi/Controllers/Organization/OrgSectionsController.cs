...
namespace ProvinciaNET.SelfManagement.WebApi.Controllers.Organization
{
    ...
    public class OrgSectionsController : ControllerBase
    {
        ...
        private readonly ICrudServiceBase<OrgSection> _service;
        ...
        public OrgSectionsController(ILogger<OrgSectionsController> logger, ICrudServiceBase<OrgSection> service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        /// <summary>
        /// Gets a 'OrgSection' resurce by ID.
        /// </summary>
        ...
        /// <summary>
        /// Updates a 'OrgSection' resource by ID.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Deletes a 'OrgSection' resource by ID.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
