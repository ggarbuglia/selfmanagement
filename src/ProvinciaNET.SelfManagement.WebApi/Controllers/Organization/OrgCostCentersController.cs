...
namespace ProvinciaNET.SelfManagement.WebApi.Controllers.Organization
{
    ...
    public class OrgCostCentersController : ControllerBase
    {
        ...
        private readonly ICrudServiceBase<OrgCostCenter> _service;
        ...
        public OrgCostCentersController(ILogger<OrgCostCentersController> logger, ICrudServiceBase<OrgCostCenter> service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        /// <summary>
        /// Gets all 'OrgCostCenter' resources.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets a 'OrgCostCenter' resource by ID.
        /// </summary>
        ...
        /// <summary>
        /// Updates a 'OrgCostCenter' resource by ID.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Deletes a 'OrgCostCenter' resource by ID.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns></returns>
